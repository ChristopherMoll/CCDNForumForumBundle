            ...
            ->children()
                ...
                ->children()
                    ->arrayNode('base')
                        ...
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\BaseController')->end()
                        ->end()
                    ->end()

                    ->arrayNode('admin_board_base')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\AdminBoardBaseController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('admin_board')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\AdminBoardController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('admin_category_base')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\AdminCategoryBaseController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('admin_category')
                        ...
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\AdminCategoryController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('admin_forum_base')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\AdminForumBaseController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('admin_forum')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\AdminForumController')->end()
                        ->end()
                    ->end()

                    ->arrayNode('admin_panel')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\AdminPanelController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('user_board')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\UserBoardController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('user_category')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\UserCategoryController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('user_post_base')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\UserPostBaseController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('user_post')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\UserPostController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('user_subscription')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\UserSubscriptionController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('user_topic_base')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\UserTopicBaseController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('user_topic')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\UserTopicController')->end()
                        ->end()
                    ->end()

                    ->arrayNode('moderator_post_base')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\ModeratorPostBaseController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('moderator_post')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\ModeratorPostController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('moderator_topic_base')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\ModeratorTopicBaseController')->end()
                        ->end()
                    ->end()
                    ->arrayNode('moderator_topic')
                        ->addDefaultsIfNotSet()
                        ->canBeUnset()
                        ->children()
                            ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Controller\ModeratorTopicController')->end()
                        ->end()
                    ->end()
                ->end()
            ->end();
                        ...
                        ->arrayNode('security')
                            ...
                            ->children()
                                ->arrayNode('authorizer')
                                    ...
                                    ->end()
                                ->end()
                                ->arrayNode('context_provider')
                                    ->addDefaultsIfNotSet()
                                    ->canBeUnset()
                                    ->children()
                                        ->scalarNode('class')->defaultValue('CCDNForum\ForumBundle\Component\Security\ContextProvider')->end()
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
